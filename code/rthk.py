...
async def process_article(fg, category, article):
    try:
        ...
        for image in images:
            ...
            raw_img_url = 'https://wsrv.nl/?n=-1&we&w=720&output=webp&trim=1&url=' + urllib.parse.quote( raw_img_url )
...
async def process_category(category, url):
    ...
    feedImg = 'https://wsrv.nl/?n=-1&we&w=720&output=webp&trim=1&url=' + urllib.parse.quote( feedImg )
    fg.logo(feedImg)
