...
session = CachedSession( allowable_methods=('GET', 'HEAD'), resolver="doh://mozilla.cloudflare-dns.com/dns-query", pool_connections=1, pool_maxsize=10000, maxsize=10000, max_size=10000, backend='redis', happy_eyeballs=True )
